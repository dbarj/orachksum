...
@@&&fc_def_output_file. orachk_report_file  'report_dbvault.txt'
@@&&fc_def_output_file. orachk_zip_file     'orachk_dbvault.zip'

---------------- END PRETASKS 1 ----------------

@@&&fc_set_value_var_decode. orachk_table_name '&&is_ver_ge_12.' 'Y' 'DBA_DV_REALM' 'DBA_DV_REALM'
DEF orachk_table_owner   = 'DVSYS'
DEF orachk_subject       = 'DV Realm'
DEF orachk_file_pref     = 'dv_realm'
DEF orachk_srczip_pref   = 'dbvault'
DEF orachk_sql_file      = 'create_csv_db_vault.sql'
...
DEF orachk_file_pref     = 'dv_realm_auth'
DEF orachk_srczip_pref   = 'dbvault'
DEF orachk_sql_file      = 'create_csv_db_vault.sql'
DEF orachk_comp_column   = ''
@@&&orachksum_fc_run_check_tables.
...
DEF orachk_file_pref     = 'dv_realm_object'
DEF orachk_srczip_pref   = 'dbvault'
DEF orachk_sql_file      = 'create_csv_db_vault.sql'
DEF orachk_comp_column   = ''
@@&&orachksum_fc_run_check_tables.
...
DEF orachk_file_pref     = 'dv_rule_set'
DEF orachk_srczip_pref   = 'dbvault'
DEF orachk_sql_file      = 'create_csv_db_vault.sql'
DEF orachk_comp_column   = ''
@@&&orachksum_fc_run_check_tables.
...
DEF orachk_file_pref     = 'dv_command_rule'
DEF orachk_srczip_pref   = 'dbvault'
DEF orachk_sql_file      = 'create_csv_db_vault.sql'
DEF orachk_comp_column   = ''
@@&&orachksum_fc_run_check_tables.
